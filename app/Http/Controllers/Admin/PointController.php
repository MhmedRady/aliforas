...
class PointController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        return view('admin.content.points.index')->with(compact('settings'));
    }

    public function index_post(Request $request)
    {
        $point_value = MainSetting::where('key', 'point_value')->first();
    ...
    public function create()
    {
        ...
        return view('admin.content.points.create', compact('countries', 'states'));
    }
    ...
    public function edit(Point $point, $id)
    {
        ...
        $states = State::all();
        $row = Point::find($id);
        return view('admin.content.points.edit', compact('countries', 'states', 'row'));
