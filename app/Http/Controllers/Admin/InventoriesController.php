...
class InventoriesController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        $data = ['rows' => $inventory];
        return view('admin.content.inventories.index')->with($data);
    }

    public function create()
    {
        $areas = State::all();
        return view('admin.content.inventories.create')->with(compact('areas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $logPayload = ['msg' => 'Inventory Added', 'model_id' => $inventory->id, 'user_id' => auth()->id()];
    ...
    public function update(Request $request, Inventory $inventory)
    {
        ...
        $logPayload = ['msg' => 'Inventory Updated', 'model_id' => $inventory->id, 'user_id' => auth()->id()];
        logToDatabase($logPayload);
        return redirect()->route('admin.inventories.index');
