...
class LocationsController extends Controller
{
    ...
    {
        return view('admin.content.locations.index');
    }
    ...
    public function create()
    {
        ...
        $cities = City::all();
        return view('admin.content.locations.create', compact('cities'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $logPayload = ['msg' => 'Location Added', 'model_id' => $location->id, 'user_id' => auth()->id()];
    ...
    public function edit(Location $location)
    {
        ...
        return view('admin.content.locations.edit', compact('cities', 'row'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $logPayload = ['msg' => 'Location Updated', 'model_id' => $location->id, 'user_id' => auth()->id()];
        logToDatabase($logPayload);
        return redirect()->route('admin.locations.index');
