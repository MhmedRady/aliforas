...
class ReturnReasonController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        return view('admin.content.return_reasons.index', compact('returns'));
    }
    ...
    {
        return view('admin.content.return_reasons.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $logPayload = ['msg' => 'Return Reason Added', 'model_id' => $return->id, 'user_id' => auth()->id()];
    ...
    public function edit(ReturnReason $returnReason)
    {
        ...
        return view('admin.content.return_reasons.edit')->with($data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $logPayload = ['msg' => 'Reason Updated', 'model_id' => $return->id, 'user_id' => auth()->id()];
        logToDatabase($logPayload);
        return redirect()->route('admin.return_reasons.index');
    }
