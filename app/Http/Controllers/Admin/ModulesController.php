...
class ModulesController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        $query = Module::query()->where('id', '!=', 13);
        ...
        $data = ['rows' => $module];
        return view('admin.content.modules.index')->with($data);
    }

    public function show(Module $module)
    {
        $data = ['row' => $module];
        return view('admin.content.modules.show')->with($data);
    }
    ...
    public function edit(Module $module)
    {
        ...
        return view('admin.content.modules.edit')->with($data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $module->save();
        $logPayload = ['msg' => 'Module Updated', 'model_id' => $module->id, 'user_id' => auth()->id()];
