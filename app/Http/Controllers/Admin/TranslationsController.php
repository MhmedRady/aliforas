...
class TranslationsController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        return view('admin.content.translations.index')->with($data);
    }
...
//                $back .= '<a href="'. route('admin.translations.show', $product->id) .'" class="btn waves-effect waves-light btn-outline-warning" title="edit">Show</a>';
    ...
    public function store(Request $request)
    {
        ...
        $translation->save();
        $logPayload = ['msg' => 'Translation Added', 'model_id' => $translation->id, 'user_id' => auth()->id()];
    ...
    public function show(Translation $translation)
    {
        ...
        return view('admin.content.translations.show')->with($data);
    }
    ...
    public function edit(Translation $translation)
    {
        ...
        return view('admin.content.translations.edit')->with($data);
    }
    ...
    public function update(Request $request, Translation $translation)
    {
        ...
        $translation->text = $request->text;
        $translation->save();
        $logPayload = ['msg' => 'Translation Updated', 'model_id' => $translation->id, 'user_id' => auth()->id()];
        logToDatabase($logPayload);
        return redirect()->route('admin.translations.index');
