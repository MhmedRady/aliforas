...
class ComboController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        return view('admin.content.combo.index', compact('products'));
    }
...
//  }
    ...
    public function create()
    {
        ...
        return view('admin.content.combo.create', compact('categories', 'brands', 'manufacturers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(PrioritySetting::first()->enable==1){
            $order_id=\App\Priority::where('name','combo')->first()->order_id;
...
//    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.content.combo.edit', compact('product','categories'));
    }
