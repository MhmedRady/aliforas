...
class SettingController extends Controller
{
    ...
    {
        $setting = Setting::all();
        return view('admin.content.setting.index', compact('setting'));
    }
    ...
    public function main_setting()
    {
        ...
        return view('admin.content.setting.main')->with(compact('facebook_id', 'facebook_secret', 'google_id', 'google_secret', 'twitter_id', 'twitter_secret', 'settings'));
    }
    ...
    public function main_settings_rows()
    {
        ...
        foreach ($keys as $key) {
            $check = MainSetting::where('key', $key)->first();
            if (!$check) {
    ...
    {
        $len = Language::all();
        return view('admin.content.setting.create', compact('len'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $logPayload = ['msg' => 'Setting Added', 'model_id' => $setting->id, 'user_id' => auth()->id()];
