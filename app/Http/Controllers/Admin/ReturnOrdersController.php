...
class ReturnOrdersController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        return view('admin.content.orders.returns', compact('orders'));
    }
    ...
    public function approve_return(Request $request)
    {
        ...
        if ($update_order->return_bank == 1) {
            $withdraw = Withdraw::where('order_line_id', $update_order)->first();
            if ($withdraw) {
    ...
    public function show($id)
    {
        ...
        return view('admin.content.orders.show', compact('order', 'total_price'));
    }
