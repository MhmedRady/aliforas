...
class DealSectionController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        $data = ['rows' => $sections];
        return view('admin.content.dealsection.index')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.content.dealsection.create', compact('products', 'cats'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $logPayload = ['msg' => 'Deal Section Added', 'model_id' => $dealsection->id, 'user_id' => auth()->id()];
    ...
    public function show(DealSection $dealsection)
    {
        ...
        return view('admin.content.dealsection.show')->with($data);
    }
    ...
    public function edit(DealSection $dealsection)
    {
        ...
        return view('admin.content.dealsection.edit')->with($data);
    }
    ...
    public function update(Request $request, DealSection $dealsection)
    {
        ...
        $logPayload = ['msg' => 'Deal Sections Updated', 'model_id' => $dealsection->id, 'user_id' => auth()->id()];
        logToDatabase($logPayload);
        return redirect()->route('admin.dealsection.index');
