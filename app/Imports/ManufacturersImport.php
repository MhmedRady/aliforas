...
//        $brand_translation->save();
        ...
        $manufacturer_ar = ManufacturerTranslation::where('manufacturer_id',$manufacturer_id)->where('locale','ar')->first();
        $manufacturer_en = ManufacturerTranslation::where('manufacturer_id',$manufacturer_id)->where('locale','en')->first();
