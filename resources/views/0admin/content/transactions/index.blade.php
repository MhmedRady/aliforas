        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="{{route('admin.transactions.create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i
...
@section('page-script')
    ...
    <script>
        const dataTable = $('#myTable').DataTable({
            ...
            "columns": [
                {"data": "id"},
                {"data": "user", width: "30%", "class": "text-left"},
                {"data": "order", width: "30%", "class": "text-left"},
                {"data": "amount", width: "30%", "class": "text-left"},
                {"data": "payment_type", width: "30%", "class": "text-left"},
            ],
            "order": [
                [0, "desc"]
            ],
