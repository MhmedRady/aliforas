...
{{--                </ul>--}}
                ...
                <form action="{{route('admin.update-order-price',$order)}}" method="post">
                    @csrf
                    <!-- table -->
                    <div class="table-responsive mb-3">
                        <table class="table table-bordered text-nowrap text-center">
                            ...
                            <tr style="border-bottom: none;font-size: 1rem;">
                                <th scope="row" class="table-active"><strong><u>Total Prices</u></strong></th>
                                <th colspan="4" class="text-start pb-0" style="border: 2px solid #f3f2f7;font-size: 1rem;">
                                    <strong>
                                        <u><input id="Prices" class="form-control disabled" type="text" name="prices" value="{{$order->total}}" readonly style="padding: 2px"></u>
                                        EGP
                                    </strong>
                                </th>
                            </tr>
