            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        {!! Form::open(["enctype" => "multipart/form-data", 'url' => route('admin.states.update', $row->id), 'class' => 'tab-wizard vertical wizard-circle', 'id' => 'add_category_form']) !!}
                        {{ method_field('PATCH') }}
                        ...
                        @foreach($languages as $locale)
                            ...
                            <section>
                                <div class="form-group">
                                    <label for="name[{{$locale->locale}}]">State name in  {{$locale->name}} :</label>
...
@section('page-style')
    ...
    <link href="{{asset('admin-asset/assets/node_modules/select2/dist/css/select2.min.css')}}" rel="stylesheet">
