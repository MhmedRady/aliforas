...
@include('admin.table.ajaxTable-inline', [
    ...
    'title' => 'Products',
    'columns' => ['name', 'image' ,'category_title', 'brand_title', 'manufacturer_title', 'status'],
    'createPopup' => false
])
@endsection
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!!$product->is_active ? '<a href="'.route('admin.products.active', $product->id).'" class="btn waves-effect waves-light btn-outline-success" title="active">Activate</a>':'<a href="'.route('admin.products.active', $product->id).'" class="btn waves-effect waves-light btn-outline-danger" title="inactive">InActivate</a>'!!}
