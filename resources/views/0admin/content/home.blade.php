                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h2 class="counter text-primary">{{$usersCount}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h2 class="counter text-cyan">{{$ordersCount}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h2 class="counter text-purple">{{$ordersCount}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h2 class="counter text-success">{{$productsCount}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <h4 class="cmin-height">My Acting blown <span
                                                    class="font-medium">Your Mind</span> and you also <br/>laugh at the
                                                moment</h4>
                                            <div class="d-flex no-block">
                                                <span><img src="{{ asset('admin-asset/assets/images/users/1.jpg') }}"
                                        ...
                                        <div class="carousel-item">
                                            <h4 class="cmin-height">My Acting blown <span
                                                ...
                                                moment</h4>
                                            <div class="d-flex no-block">
                                                <span><img src="{{ asset('admin-asset/assets/images/users/2.jpg') }}"
                                                           alt="user" width="50" class="img-circle"></span>
                                                <span class="m-l-10">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                                        ...
                                        <div class="carousel-item">
                                            <h4 class="cmin-height">My Acting blown <span
                                                ...
                                                moment</h4>
                                            <div class="d-flex no-block">
                                                <span><img src="{{ asset('admin-asset/assets/images/users/3.jpg') }}"
                                                           alt="user" width="50" class="img-circle"></span>
                                                <span class="m-l-10">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                            ...
                            @if($orders_recent->count() > 0)
                                @foreach($orders_recent as $rec_order)
                                    <tr>
                                        ...
                                        <td><span
                                                class="badge badge-success badge-pill">{{$rec_order->status->name}}</span>
                                        </td>
                        ...
                        <div class="to-do-widget m-t-20" id="todo" style="height: 400px;position: relative;">
                            ...
                            <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                <li class="list-group-item" data-role="task">
                                    ...
                                    <ul class="assignedto">
                                        <li><img src="{{ asset('admin-asset/assets/images/users/1.jpg') }}" alt="user"
                                                 data-toggle="tooltip" data-placement="top" title=""
                                                 data-original-title="Steave"></li>
                                        <li><img src="{{ asset('admin-asset/assets/images/users/2.jpg') }}" alt="user"
                                                 data-toggle="tooltip" data-placement="top" title=""
                                                 data-original-title="Jessica"></li>
                                        <li><img src="{{ asset('admin-asset/assets/images/users/3.jpg') }}" alt="user"
                                                 data-toggle="tooltip" data-placement="top" title=""
                                                 data-original-title="Priyanka"></li>
                                        <li><img src="{{ asset('admin-asset/assets/images/users/4.jpg') }}" alt="user"
                                                 data-toggle="tooltip" data-placement="top" title=""
                    ...
                    <div class="card-body">
                        ...
                        <div class="message-box" id="msg" style="height: 430px;position: relative;">
                            <div class="message-widget message-scroll">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="user-img"><img
                                            src="{{ asset('admin-asset/assets/images/users/2.jpg') }}" alt="user"
                                ...
                                <a href="javascript:void(0)">
                                    <div class="user-img"><img
                                            src="{{ asset('admin-asset/assets/images/users/4.jpg') }}" alt="user"
                            ...
                            <ul class="chat-list">
                                ...
                                <li>
                                    <div class="chat-img"><img
                                            src="{{ asset('admin-asset/assets/images/users/1.jpg') }}" alt="user"></div>
                                ...
                                <li>
                                    <div class="chat-img"><img
                                            src="{{ asset('admin-asset/assets/images/users/2.jpg') }}" alt="user"></div>
                                    <div class="chat-content">
                                        <h5>Bianca Doe</h5>
                                ...
                                <li>
                                    <div class="chat-img"><img
                                            src="{{ asset('admin-asset/assets/images/users/3.jpg') }}" alt="user"></div>
                                    <div class="chat-content">
