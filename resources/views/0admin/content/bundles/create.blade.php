                    ...
                    <div class="card-body wizard-content">
                        ...
                        @foreach($languages as $locale)
                            <div class="form-group">
                                ...
                                <input type="text" name="name[{{$locale->locale}}]" class="form-control required" required maxlength="40">
                            </div>
                            <div class="form-group">
                        ...
                        @endforeach
                            <div class="form-group">
                                ...
                                <input class="bundle_image" accept="image/*" type="file" name="bundle_image" class="form-control" required="required">
                            </div>
                            <div class="form-group">
