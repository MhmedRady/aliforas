            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        {!! Form::open(["enctype" => "multipart/form-data", 'url' => route('admin.shipping_zones.update', $row->id), 'class' => 'tab-wizard vertical wizard-circle', 'id' => 'add_category_form']) !!}
                        {{ method_field('PATCH') }}
                        <section>
                            <div class="form-group">
                                ...
                                <select name="company_id" class="select2 form-control">
                                    ...
                                    <option value="{{$company->id}}" @if($company->id == $row->company_id) selected @endif>{{$company->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </section>
                        <section>
                            <div class="form-group">
                                ...
                                <input type="text" name="zone_name" class="form-control" value="{{$row->zone_name}}">
                            </div>
                        </section>
                        <section>
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single form-control" name="areas[]" multiple="multiple">
                                    @foreach($areas as $area)
                                        <option value="{{$area->id}}" @if(in_array($area->id,json_decode($row->areas))) selected @endif>{{$area->name}}</option>
                                    @endforeach
                                </select>
                                @error('areas')
                        ...
                        <section>
                            <div class="form-group">
                                ...
                                <input type="text" name="first_kg" class="form-control" value="{{$row->first_kg}}">
                            </div>
                        </section>
                        <section>
                            <div class="form-group">
                                <label for="additional_kg">Additional Kg:</label>
                                <input type="text" name="additional_kg" class="form-control" value="{{$row->additional_kg}}">
                            </div>
                        </section>
                        <section>
                            <div class="form-group">
                                <label for="cod_values">Cod Values:</label>
                                <input type="text" name="cod_values" class="form-control" value="{{$row->cod_values}}">
                            </div>
                        </section>
