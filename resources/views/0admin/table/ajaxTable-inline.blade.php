        ...
        $(document).ready(function () {
            ...
            let dtTable = $('#ajaxTable').DataTable({
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            if ('deleted_at' in row && row['deleted_at'] != null) {
                                ...
                                if (row['update_url'])
                                    _html.push('<a @if(isset($createPopup) && $createPopup === false) href="' + row['update_url'] + '" @else href="javascript:void(0);" data-update-url="' + row['update_url'] + '" class="model-update" @endif>' +
                ...
                language: {
                    ...
                    processing: feather.icons['refresh-cw'].toSvg({class: 'font-medium-5 mr-50'}) + '<span>Loading...</span> ',
                    paginate: {
                        previous: '&nbsp;',
                        next: '&nbsp;'
                    }
