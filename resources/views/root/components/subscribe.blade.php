<!--subscribe start-->
<section class="subscribe1 " style="background-color: rgba(172, 0, 0, 0.8);">
    <img src="{{asset('assets/images/subscribe2.png')}}" alt="subscribe" class="bg-img img-fluid">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="subscribe-contain">
                    ...
                    <div class="subscribe-right">
                        <div class="input-group">
                            <input id="SubscribeInput" class="form-control" type="text" placeholder="Enter Your Email">
                            <button id="sendSubscribe" disabled class="input-group-text">subscribe</button>
                        </div>
                        <span id="alertSubscribe" class="alertSubscribe text-warning"></span>
                    </div>
                </div>
            </div>
        </div>
