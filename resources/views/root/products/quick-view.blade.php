        ...
        {{--<article class="gallery-wrap">
            <div class="img-big-wrap">
                <div id="carouselExampleIndicators" class="carousel slide my-4" data-interval="false">
                    <ol data-simplebar class="carousel-indicators"
                        style="bottom: -10px;overflow-y: hidden;overflow-x: auto;">
                        @foreach($product->images as $image)
                            <li data-target="#carouselExampleIndicators"
                                style="height: 50px; width: 50px;min-width: 50px;min-height: 50px; text-indent: 0;text-align: center;"
                                data-slide-to="{{$loop->index}}"
                                class="@if($loop->first) active @endif">
                                <img src="{{$image->image_url(50, 50)}}">
                            </li>
                        @endforeach
                    </ol>
                    <div class="carousel-inner" role="listbox">
                        @foreach($product->images as $image)
                            <div class="carousel-item @if($loop->first) active @endif">
                                <img class="d-block img-fluid align-items-center"
                                     src="{{$image->image_url(600, 600)}}"
                                     style="margin: 0 auto;">
                            </div>
                        @endforeach
                    </div>
    ...
    <div class="product-right">
        <div class="pro-group">
            ...
            @if (config('setting.pricing') === true)
                <ul class="pro-price">
                    <li class="fs-2" style="color: #e62a16;">{{$product->price}} EGP</li>
        ...
        <div class="pro-group">
            <h6 class="product-title">{{__('layouts.productDescription')}}</h6>
            <p>
            ...
            <div class="qty-box">
                <div class="input-group">
                    <button class="qty-minus"></button>
                        <input class="qty-adj form-control quick-view-quantity" type="number" min="1" value="1" max="{{$product->stock}}">
                    <button class="qty-plus"></button>
                </div>
            </div>
            <div class="product-buttons">
                <a id="addToCartQuickView" href="javascript:void(0)" onclick="openCart()" class="btn cart-btn btn-normal tooltip-top"
                   data-tippy-content="Add to cart" data-product="{{$product->id}}">
                    <i class="fa fa-shopping-cart"></i>
                        {{__('layouts.add-to-cart')}}
                </a>
                <a href="{{ route('products.show', $product->slug) }}" class="btn btn-normal tooltip-top"
                   data-tippy-content="view detail">view detail</a>
            </div>
        </div>
    </div>
</div>
