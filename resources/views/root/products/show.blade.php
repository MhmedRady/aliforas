...
@section('content')
                        ...
                        <div class="product-right product-description-box">
                            <div class="pro-group">
                                ...
                                @if (config('setting.pricing') === true)
                                    <ul class="pro-price">
                                        <li class="fs-2" style="color: #e62a16;">{{$product->productAttributes->count() ? $product->productAttributes->first()->price:$product->price}} EGP</li>
                                        @if($product->before_price)
                                            <li class="fs-3"><span>{{$product->before_price}} EGP</span></li>
                                        @endif
                                        {{--                                        <li>50% off</li>--}}
                                    </ul>
                                    @if($product->reward_points)
                                        <div class="review-box">
                                            <ul>
                                                @for($i = 0;$product->reward_points;$i++)
                                                    <li><i class="fa fa-star"></i></li>
                                                @endfor

                                                @for($i = 0;(5-$product->reward_points);$i++)
                                                    <li><i class="fa fa-star-o"></i></li>
                                                @endfor

                                            </ul>
                                            {{--                                        <a href="{{asset('review.html')}}"><span>(6 reviews)</span></a>--}}
                                        </div>
                                    @endif
                            ...
                            @if (config('setting.pricing') === true)
                                ...
                                {{--                                                        <p>Use code "OFFER40" Min. Cart Value $99 | Max. Discount--}}
                                {{--                                                            $40</p>--}}
                                {{--                                                    </div>--}}
                                {{--                                                </li>--}}
                                {{--                                            </ul>--}}
                                ...
                                {{--                                                        <p>Use code "OFFER25" Min. Cart Value $99 | Max. Discount--}}
                                {{--                                                            $25</p>--}}
                                {{--                                                    </div>--}}
                                {{--                                                </li>--}}
                                {{--                                                <li>--}}
                                {{--                                                    <span class="code-lable">OFFER40</span>--}}
                                {{--                                                    <div>--}}
                                {{--                                                        <h5>Bank Offer40% Unlimited Cashback on bideal Axis Bank Credit--}}
                                {{--                                                            Card</h5>--}}
                                {{--                                                        <p>Use code "OFFER40" Min. Cart Value $99 | Max. Discount--}}
                                {{--                                                            $40</p>--}}
                                {{--                                                    </div>--}}
                                ...
                                {{--                                                        <p>Use code "OFFER10" Min. Cart Value $99 | Max. Discount--}}
                                {{--                                                            $10</p>--}}
                                {{--                                                    </div>--}}
                                {{--                                                </li>--}}
                                {{--                                                <li>--}}
                                ...
                                {{--                                                    <div>--}}
                                {{--                                                        <h5>Bank Offer5% Unlimited Cashback on bideal sbi banck Credit--}}
                                {{--                                                            Card</h5>--}}
                                ...
                                {{--                                                              fill="#fdcb02"></path>--}}
                                {{--                                                        <path d="m0 65 .001 96 186.267 20.333v-116.333z"--}}
                                {{--                                                              fill="#fdcb02"></path>--}}
                                {{--                                                        <path--}}
                                {{--                                                            d="m235.314 265.667 29.905-104.667h-78.951l-15.601 52.333 15.601 52.334z"--}}
                                {{--                                                            fill="#cc295f"></path>--}}
                                {{--                                                        <path d="m.001 161h186.267v104.666h-186.267z"--}}
                                {{--                                                              fill="#ff4d4d"></path>--}}
                                {{--                                                    </g>--}}
                                {{--                                                    <g>--}}
                                ...
                                @if($product->productAttributes->count())
                                    <div class="pro-group"></div>
                                    <div class="col-md-4">
                                        <div class="pro-group">
                                            <h6 class="product-title">{{__('layouts.product_attributes')}}</h6>
                                            <select id="attribute_id" name="attributes" class="form-select" autocomplete="off">
                                            {{--  <option value="0" disabled selected>Select Product Attribute</option> --}}
                                                @foreach($product->productAttributes as $attr)
                                                    @if($attr->quantity > 0)
                                                        <option value="{{$attr->id}}" data-attr="{{$attr->price}}">{{$attr->attribute->name}}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            @endif
                            <div class="pro-group">
                                <h6 class="product-title">{{__('layouts.quantity')}}</h6>
                                <div class="qty-box">
                                    <div class="input-group">
                                        <button class="qty-minus"></button>
                                        <input class="qty-adj form-control" id="qtyInput" type="number" value="1"
                                               min="1" max="{{ $product->stock }}" autocomplete="off"/>
                            ...
                            @if(config('setting.pricing'))
                                <div class="pro-group">
                                    <h6 class="product-title">{{__('layouts.deliveryOption')}}</h6>
                                        ...
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                ...
                                                <g id="surface1">
                                                    ...
                                                    <path
                                                        d="M 217.996094 128.410156 C 147.636719 128.410156 90.398438 185.652344 90.398438 256.007812 C 90.398438 326.367188 147.636719 383.609375 217.996094 383.609375 C 288.351562 383.609375 345.59375 326.367188 345.59375 256.007812 C 345.59375 185.652344 288.351562 128.410156 217.996094 128.410156 Z M 217.996094 353.5625 C 164.203125 353.5625 120.441406 309.800781 120.441406 256.007812 C 120.441406 202.214844 164.203125 158.453125 217.996094 158.453125 C 271.785156 158.453125 315.546875 202.214844 315.546875 256.007812 C 315.546875 309.800781 271.785156 353.5625 217.996094 353.5625 Z M 217.996094 353.5625 "></path>
                                                    <path
                            ...
                            <div class="pro-group pb-0">
                                <h6 class="product-title">{{__('layouts.share')}}</h6>
                                                    ...
                                                    <div class="mt-2 text-center">
                                                        <div class="single-product-tables detail-section">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>{{__('layouts.category')}}:</td>
                                                                    <td>{{$product->categories->first()->name??''}}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>{{__('layouts.brand')}}:</td>
                                                                    <td>{{$product->brand->name??''}}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>{{__('layouts.company')}}:</td>
    ...
    {{--                                {!! htmlFilter($product->description) !!}--}}
    {{--                            </div>--}}
            ...
            <div class="custom-container">
                <div class="row">
                    <div class="col-12 product-related">
                        <h2>{{__('layouts.relatedProducts')}}</h2>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div class="product-imgbox">
                                        <div class="product-front">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/1.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-back">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/a1.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="product-imgbox">
                                        <div class="product-front">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/3.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-back">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/a3.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-icon icon-inline">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="product-imgbox">
                                        <div class="product-front">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/4.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-back">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/a4.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-icon icon-inline">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="product-imgbox">
                                        <div class="product-front">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/5.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-back">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/a5.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-icon icon-inline">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="product-imgbox">
                                        <div class="product-front">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/6.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-back">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/a6.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-icon icon-inline">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="product-imgbox">
                                        <div class="product-front">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/7.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-back">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/a7.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-icon icon-inline">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="product-imgbox">
                                        <div class="product-front">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/8.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-back">
                                            <a href="{{ route('products.show', $product->slug) }}">
                                                <img src="{{asset('assets/images/layout-2/product/a8.jpg')}}"
                                                     class="img-fluid" alt="product">
                                            </a>
                                        </div>
                                        <div class="product-icon icon-inline">
...
@push('scripts')
    <script>
        ...
        quantityInput.oninput = function () {
            ...
            let maxQ = parseInt(this.getAttribute('max'))||1;
            let valQ = this.value === ''?1:parseInt(this.value);
            // console.log(valQ)
            if ( valQ > maxQ){
                this.value = maxQ;
            }else if (valQ === 1){
        ...
        $(function () {
            $('#addToCart').click(function () {
                let quantity = $('#qtyInput').val(),
                    attribute = $('#attribute_id').val()??0;
                addToCart($(this).data('productId'), quantity, attribute);
            });
            let fab = document.querySelectorAll('.fab');

            fab.forEach((el)=>{
                el.classList.replace('fab','fa');
                el.style.fontsize = '1rem';
            });
        });
        @if($product->productAttributes->count())
            attribute_id.onchange = function () {
            let selected = attribute_id.options,
                selectedPrice = selected[selected.selectedIndex].dataset.attr;
            let els = document.querySelector('.pro-price');
            if (selectedPrice !== null){
                els.firstElementChild.textContent = `${selectedPrice} EGP`;
            }
        }
        @endif
    </script>
