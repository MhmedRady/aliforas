    ...
    <div class="scroll-sidebar">
        ...
        <div class="user-profile">
            <div class="user-pro-body">
                <div><img src="{{asset('admin-asset/assets/images/users/2.jpg')}}" alt="user-img" class="img-circle">
                </div>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu animated flipInY">
                        <!-- text-->
                        <a href="{{url(route('admin.users.show',[Auth::user()->id]))}}" class="dropdown-item"><i
        ...
        <nav class="sidebar-nav">
            ...
            <ul id="sidebarnav">
                <li><a class="waves-effect waves-dark" href="{{ route('admin.home')  }}" aria-expanded="false"><i
                            class="icon-speedometer"></i><span class="hide-menu">Dashboard</span></a></li>
                <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                            class="ti-user"></i><span class="hide-menu">Users Management</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('admin.users.index')}}">Admins</a></li>
                        <li><a href="{{route('admin.permission-group.index')}}">Permissions Groups</a></li>
                        <li><a href="{{route('admin.permissions.index')}}">Permissions</a></li>
                        <li><a href="{{route('admin.roles.index')}}">Roles</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                            class="ti-user"></i><span class="hide-menu">Client Management</span></a>
                    <ul aria-expanded="false" class="collapse">
                ...
                {{--<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-user"></i><span class="hide-menu">Seller Management</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('seller.list')}}">Sellers</a></li>
                    </ul>
                </li>--}}
                <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                            class="ti-layout-grid2"></i><span class="hide-menu">Catalog</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="{{route('admin.images.index')}}">Bulk Image Upload</a></li>
                        <li><a href="{{route('admin.dealsection.index')}}">Deal Sections</a></li>

                    </ul>
                </li>
                <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                            class="ti-layout-grid2"></i><span class="hide-menu">Orders</span></a>
                    <ul aria-expanded="false" class="collapse">
            ...
            <!--<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Shipping Setting</span></a>
                ...
                <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                            class="ti-layout-grid2"></i><span class="hide-menu">Marketing</span></a>
                    <ul aria-expanded="false" class="collapse">
                ...
                <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                            class="ti-layout-grid2"></i><span class="hide-menu">Destination</span></a>
                    <ul aria-expanded="false" class="collapse">
                ...
                <li><a class="waves-effect waves-dark" href="{{route('admin.modules.index')}}" aria-expanded="false"><i
                            class="ti-layout-accordion-merged"></i><span class="hide-menu">Modules</span></a></li>
                <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="{{route('admin.priority')}}">Offer Setting</a></li>
                    <!--<li><a href="{{route('admin.setting.index')}}">Setting</a></li>-->
                    </ul>
                </li>
                <li><a class="waves-effect waves-dark" href="{{ route('admin.page.index')  }}" aria-expanded="false"><i
                            class="ti-layout-accordion-merged"></i><span class="hide-menu">Pages</span></a></li>
            ...
            <!--        <li><a href="{{route('admin.locations.index')}}">Locations</a></li>-->
                <!--    </ul>-->
                <!--</li>-->
                <li><a class="waves-effect waves-dark" href="{{route('admin.logs')}}" aria-expanded="false"><i
                            class="ti-layout-accordion-merged"></i><span class="hide-menu">Dashboard Logs</span></a>
                </li>
