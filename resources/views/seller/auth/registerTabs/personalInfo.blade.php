    ...
    <div class="row">
        <div class="mb-1 col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="document_first_name" class="form-control" name="first_name" value="{{old('first_name')}}"/>
                @error('first_name')
        ...
        <div class="mb-1 col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="document_last_name" class="form-control" name="last_name" value="{{old('last_name')}}"/>
                @error('last_name')
