    ...
    <div class="row">
        <div class="mb-1 col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="store" class="form-control" name="store" value="{{old('store')}}"/>
                @error('store')
    ...
    <div class="row">
        ...
        <div class="mb-1 col-md-6">
            ...
            <select class="select2 w-100" id="city" name="city" autocomplete="off">
                @if(old('state'))
                    @foreach($states->find(old('state'))->cities as $city)
    ...
    <div class="row">
        ...
        <div class="mb-1 col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="build_number" class="form-control" name="build_number" value="{{old('build_number')}}"/>
                @error('build_number')
    ...
    <div class="row">
        <div class="mb-1 col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="postal_code" class="form-control" name="postal_code" value="{{old('postal_code')}}"/>
                @error('postal_code')
                <div id="validationStore_name" class="invalid-feedback d-block">
                    {{$message}}
                </div>
        ...
        <div class="mb-1 col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="pickup_phone" class="form-control" name="pickup_phone" value="{{old('pickup_phone')}}"/>
                @error('pickup_phone')
                <div id="validationPickup_contact_number" class="invalid-feedback d-block">
                    {{$message}}
                </div>
