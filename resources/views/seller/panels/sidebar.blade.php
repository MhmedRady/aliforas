...
<div
    ...
    <div class="main-menu-content w-100">
        <ul class="navigation navigation-main w-100" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    @if($menu !== null)
                        ...
                        @else
                            ...
                            <li @class([
                                ...
                                'active' => (Route::currentRouteName() === optional($menu)['slug']
                                || Str::startsWith(Route::currentRouteName(), optional($menu)['slug']))
                            ])>
                                ...
                                @if(isset($menu['submenu']))
                                    @include('seller.panels.submenu', ['menu' => $menu['submenu']])
                                @endif
                            </li>
                        @endif
                    @endif
