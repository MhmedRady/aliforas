            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        {!! Form::open(['url' => route('admin.orders.store'), 'class' => 'tab-wizard vertical wizard-circle', 'id' => 'add_user_form']) !!}
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('country_id', ['egypt', 'turkey'], null, ['class'=>'form-control', 'required' => 'required'])}}
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('city_id', ['cairo', 'alex'], null, ['class'=>'form-control', 'required' => 'required'])}}
