<h6 class="text-info">Stock Details</h6>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control required" id="price" min="0" value="{{ old('reward_points') === null ? 0 : old('reward_points')}}" name="reward_points">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="on_sale">
                                    <input type="checkbox" id="on_sale" {{isset($issale) && $issale?'checked':''}} name="on_sale" >
                                    On sale?
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="is_hot">
                                    <input type="checkbox" id="is_hot" name="is_hot" {{isset($ishot) && $ishot?'checked':''}}>
                                    Is hot product?
                                </label>
                            </div>
