...
@section('content')
    ...
    <section class="modern-horizontal-wizard">
        <div class="bs-stepper wizard-modern modern-wizard-example">
            @include('seller.content.products.create.links')
            <div class="bs-stepper-content">
                ...
                <form id="productForm" action="{{route('seller.products.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    {{-- PRODUCT DETALIS --}}
                    @include('seller.content.products.create.info')

                    {{-- PRODUCT STOCK DETALIS --}}
                    @include('seller.content.products.create.stock')

                    {{-- PRODUCT IMAGES --}}
                    @include('seller.content.products.create.images')

                    @if(config('setting.pricing'))
                        {{-- PRODUCT ATTRIBUTES --}}
                        @include('seller.content.products.create.attributes')
                    @endif

                    {{-- PRODUCT MAIN INFO --}}
                    @include('seller.content.products.create.main-info')
