    ...
    <div class="row">
        ...
        <div class="mb-1 col-md-4">
            ...
            <select class="form-select" name="brand_id" id="brand_id">
                <option value="0" disabled>@lang('Select') @lang('layouts.brand')</option>
        ...
        <div class="mb-1 col-md-4">
            ...
            <select class="form-select" name="branch_id" id="branch_id">
                <option value="0" disabled>@lang('Select') @lang('layouts.branch')</option>
    ...
    <div class="row">
        ...
        <div class="mb-1 col-md-6">
            ...
            <select class="form-select" name="manufacturer_id" id="manufacturer_id">
                <option value="0" disabled>@lang('Select') @lang('layouts.company')</option>
