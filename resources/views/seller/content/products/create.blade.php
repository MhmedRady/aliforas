    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">{{__('layouts.products')}}</h4>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        @foreach($languages as $locale)
                            ...
                            <section>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug[{{$locale->locale}}]" class="form-control required" value="{{ old("slug." . $locale->locale) }}" required maxlength="40">
                                </div>
                        ...
                        <h6>Stock</h6>
                        <section>
                          @include('admin.content.products.accordians.stock')
                        </section>

                        <h6>Images</h6>
                        <section>
                        @include('admin.content.products.accordians.images')
                        </section>

                        <h6>Meta Content</h6>
                        <section>
                        @include('admin.content.products.accordians.main-info')
                        </section>

                        <h6>Attributes</h6>
                        <section>
                        @include('admin.content.products.accordians.attributes')
