...
@section('content')
    ...
    <section class="modern-horizontal-wizard">
        <div class="bs-stepper wizard-modern modern-wizard-example">
            @include('seller.content.products.edit.links')
...
{{--                @endif--}}
                ...
                <form id="productForm text-start" action="{{route('seller.products.update',$row)}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    @method('PUT')

                    {{-- PRODUCT DETALIS --}}
                    @include('seller.content.products.edit.info')

                    {{-- PRODUCT STOCK DETALIS --}}
                    @include('seller.content.products.edit.stock')

                    {{-- PRODUCT IMAGES --}}
                    @include('seller.content.products.edit.images')

                    @if(config('setting.pricing'))
                        {{-- PRODUCT ATTRIBUTES --}}
                        @include('seller.content.products.edit.attributes')
                    @endif

                    {{-- PRODUCT MAIN INFO --}}
                    @include('seller.content.products.edit.main-info')
...
@section('page-script')
    ...
    <script>
        ...
        $('.delete-attribute').on('click',function (){
            ...
            if (attrConfirm)
            {
                let route = `{{route('seller.att-product-before-delete')}}${$(this).data('attr-id')}` ;
                $.ajax({
                    url: route,
