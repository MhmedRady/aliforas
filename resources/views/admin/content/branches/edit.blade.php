                ...
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.home')}}">{{__('layouts.home')}}</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.branch.index')}}">{{__('layouts.branches')}}</a>
                        </li>
                        <li class="breadcrumb-item active">{{__('auth.edit')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                @foreach($languages as $locale)
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control" id="nameInput_{{$locale->locale}}"
                                                   name="name[{{$locale->locale}}]" value="{{old("title.$locale->locale")??($branch->translate($locale->locale)->name)}}"/>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="pac-input" name="address"
                                               value="{{old("address")?? $branch->address}}" autocomplete="off"/>
                                        @error("address")
                                        <div class="invalid-feedback d-block">
                                            {{$message}}
                                        </div>
                                        @enderror
                                        <input type="hidden" id="latitude" name="lat" class="form-control" value="{{old('lat')??$branch->lat}}"/>

                                        <input type="hidden" id="longitude" name="lng" class="form-control" value="{{old('lng')??$branch->lng}}"/>
        ...
        function initAutocomplete() {
            ...
            $('.map').each(function(){
                ...
                var map = new google.maps.Map($('.map')[$index], {
                    center: {lat: {{(old('lat')??$branch->lat)??30.033333}} , lng: {{(old('lng')??$branch->lng)??31.233334}}},
                    zoom: 13,
                    mapTypeId: 'roadmap'
                });
