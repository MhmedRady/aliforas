            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="{{route('admin.bundles.index')}}">Bundles</a></li>
                        ...
                        <section>
                            ...
                            @foreach($languages as $locale)
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $product->translate($locale->locale)->name ?? '' }}" name="name[{{$locale->locale}}]" class="form-control required" required maxlength="40">
                                </div>
                                <div class="form-group">
                                    <label for="slug[{{$locale->locale}}]">Slug {{$locale->name}} :</label>
                                    <input type="text" name="slug[{{$locale->locale}}]" value="{{ $product->translate($locale->locale)->slug ?? '' }}" class="form-control" maxlength="40">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="bundle_image" accept="image/*" type="file" name="bundle_image" class="form-control" >
                            </div>
                            <div class="form-group">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($bundles as $bundle)
                                        <tr>
                                            ...
                                            <td><input type="number" name="price[]" id="five"  class="form-control price" value="{{ $bundle->quantity * $bundle->product->before_price }}"  disabled="" required /></td>
                                            <td><input type="text" name="discount[]" class="form-control discount" value="{{ $bundle->discount }}" required /></td>
                                            <td><input type="number" name="price_after[]" class="form-control price_after" value="{{ $bundle->product->before_price * $bundle->quantity - $bundle->discount }}" required disabled="" /></td>
                                            <td>
                                                <a href="#" class="btn btn-danger remote-product">[DELETE]</a>
                                            </td>
                                            <td><input type="hidden" name="rootPrice" class="form-control rootPrice" value="{{ $bundle->product->before_price }}" min="1" required /></td>
                                        </tr>
                                    @endforeach
                                    @endif
