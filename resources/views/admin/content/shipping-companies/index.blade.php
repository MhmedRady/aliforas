...
{{--                <h4 class="text-themecolor">Shipping Companies</h4>--}}
{{--            </div>--}}
...
{{--            "ajax": {--}}
{{--                url: '{{ route('admin.shipping_companies.index') }}',--}}
{{--                type: "POST",--}}
{{--                headers: {--}}
...
{{--                { "data": "fuel", width: "25%", searchable: false, orderable: false, "class": "text-left"},--}}
{{--                { "data": "post", width: "25%", searchable: false, orderable: false, "class": "text-left"},--}}
{{--                { "data": "vat", width: "25%", searchable: false, orderable: false, "class": "text-left"},--}}
{{--                { "data": "cod", width: "25%", searchable: false, orderable: false, "class": "text-left"},--}}
{{--                { "data": "first_kg_number", width: "25%", searchable: false, orderable: false, "class": "text-left"},--}}
