<div id="personal-info-modern" class="content" role="tabpanel" aria-labelledby="personal-info-modern-trigger">
    ...
    <div class="row">
        <div class="mb-1 col-md-6">
            ...
            <input type="text" id="Price" class="form-control" value="1" min="1" name="price">
        </div>
        <div class="mb-1 col-md-6">
    ...
    <div class="row">
        ...
        <div class="mb-1 col-md-6">
            <div class="form-switch">
                <input type="checkbox" class="form-check-input" id="return_allowed" name="return_allowed" autocomplete="off"/>
            ...
            <div class="form-check form-switch" data-show="return_allowed" style="display: none">
                ...
                <input type="text" id="return_duration" class="form-control" name="return_duration" value="{{old('return_duration')??0}}" max="30">
            </div>
        </div>

        <div class="mb-1 col-md-6">
            <div class="form-switch">
                <input type="checkbox" class="form-check-input" id="on_sale" name="on_sale" autocomplete="off"/>
            ...
            <div class="form-check form-switch" data-show="on_sale" style="display: none">
                ...
                <input type="text" class="form-control" min="0" id="before_price" name="before_price" value="{{ old('before_price') }}">
            </div>
            <div class="form-check form-switch" data-show="on_sale" style="display: none">
        ...
        <div class="mb-1 col-md-6">
            <div class="form-switch">
                <input type="checkbox" class="form-check-input" id="is_hot" name="is_hot" autocomplete="off"/>
            ...
            <div class="form-check form-switch" data-show="is_hot" style="display: none">
                ...
                <input type="text" class="form-control" min="0" id="hot_price" name="hot_price" value="{{ old('hot_price') }}">
            </div>
        </div>
