<div id="personal-info-modern" class="content" role="tabpanel" aria-labelledby="personal-info-modern-trigger">
    ...
    <div class="row">
        ...
        <div class="mb-1 col-md-6">
            ...
            <input type="number" id="minimum_stock" class="form-control" name="minimum_stock" value="{{old('minimum_stock')??$row->minimum_stock}}">
        </div>
    </div>
    <div class="row">
        <div class="mb-1 col-md-6">
        ...
        <div class="mb-1 col-md-6">
            <label class="form-label" for="reward_points">Low Stock Notification</label>
    ...
    <div class="row">
        <div class="mb-1 col-md-6">
            ...
            <div class="form-switch">
                <input type="checkbox" class="form-check-input" id="return_allowed" name="return_allowed" {{$row->return_allowed?'checked':''}} autocomplete="off"/>
        ...
        <div class="mb-1 col-md-6">
            <div class="form-switch">
                <input type="checkbox" class="form-check-input" id="on_sale" name="on_sale" {{$row->on_sale?'checked':''}} autocomplete="off"/>
        ...
        <div class="mb-1 col-md-6">
            <div class="form-switch">
                <input type="checkbox" class="form-check-input" id="is_hot" name="is_hot" {{$row->is_hot ?'checked':''}} autocomplete="off"/>
