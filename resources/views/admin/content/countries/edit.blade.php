            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        {!! Form::open(["enctype" => "multipart/form-data", 'url' => route('admin.countries.update', $row->id), 'class' => 'tab-wizard vertical wizard-circle', 'id' => 'add_category_form']) !!}
                        {{ method_field('PATCH') }}
                        ...
                        <section>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="country_code" id="country_code" value="{{ $row->country_code }}">
                            </div>
