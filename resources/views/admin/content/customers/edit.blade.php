            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        {!! Form::open(['url' => route('admin.customers.update', $user->id), 'class' => 'tab-wizard vertical wizard-circle', 'id' => 'edit_user_form']) !!}
                            {{ method_field('PUT') }}
                            <!-- sec section -->
...
{{--                                </div>--}}
                            ...
                            <section>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div class="card" style="border:1px solid #ced4da;border-radius:0;">
                                        <div class="card-body" style="padding:13px 25px;">
                                            <input type="radio" name="gender" value="1" {{ ($user->gender == 'Male') ? 'checked' : ''}}> Male
                                            <input type="radio" name="gender" value="2" {{ ($user->gender == 'Female') ? 'checked' : ''}}> Female
                                        </div>
                                    </div>
                                    @error('gender')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input id="dob" type="date" class="form-control" name="dob" value="{{ old('dob')??$user->dob }}" autocomplete="dob">
                                    @error('dob')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                @if(config('setting.pricing') === false)
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="employer" class="form-control" value="{{old('employer') ?? $user->employer }}">
                                        @error('employer')
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
