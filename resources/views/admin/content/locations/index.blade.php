        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="{{route('admin.locations.create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
...
@section('page-script')
    ...
    <script>
        const dataTable = $('#myTable').DataTable({
            ...
            "columns": [
                { "data": "id"},
                { "data": "location", width: "30%", "class": "text-left"},
                { "data": "city", width: "25%", searchable: false, orderable: false, "class": "text-left"},
