          ...
          @if(session()->has('message'))
            ...
            <div class="order-detail-content">
                ...
                <table class="table table-bordered cart_summary">
                  ...
                  @foreach($cart as $product)
                    ...
                    <tr class="cart-line-{{$product['id']}}">
                      ...
                      <td class="price"><span>{{$pro->getFinalPriceAfterDiscountPriority()}}
                      @if($pro->is_offer() )

                        <span class="old-price" style="text-decoration: line-through">{{$pro->getFinalOldPricePriority()}}</span>
              ...
              <div class="cart_navigation">
                <a class="continue-btn" href="{{url('/'.$locale)}}"><i class="fa fa-arrow-left sc"> </i>&nbsp; {{__('User.Continue shopping')}}</a>
                <a class="checkout-btn" href="{{route("web.checkout.show")}}"><i class="fa fa-check"></i> {{__('User.Proceed to checkout')}}</a> </div>
            </div>
          </div>
        </div>
      </div>
