    <!-- subscribe start -->
        <section class="subscribe1 newsletter-inverse" style="background-color: #a60202;">
            <img src="{{asset("website/images/marketplace/subscribe2.png")}}"  alt="subscribe" class="bg-img img-fluid">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
...
{{--                                        </h6>--}}
                            ...
                            <form id="_form-email-subscribe" class="subscribe-right" action="{{route('web.email-subscribe')}}" method="post">
                                @csrf
                                <div class="input-group">
                                    <input class="form-control" type="text" placeholder="Enter Your Email" name="email">
                                    <button id="_email-subscribe" type="button" class="input-group-text btn btn-normal"
                                            style="padding-bottom: 13px;background-color: #ae0615;">subscribe</button>

                                </div>
                                <div id="subscribeFeedback"
                                     class="badge font-85 d-block"
