                    ...
                    <div class="col-lg-4">
                        <div class="product-slick">
                            @foreach($images as $key => $img)
                                <div><img src="{{$img->image_url}}" alt="{{"$slug-$key"}}" class="img-fluid  image_zoom_cls-{{$key}}"></div>
                            @endforeach
                        </div>
                        <div class="row">
                    ...
                    <div class="col-lg-5 rtl-text">
                        <div class="product-right ">
                            ...
                            <div class="pro-group">
                                <h2>{{$name}}</h2>
                                <ul class="pro-price">
{{--                                    <li>EGP {{$product->price}}</li>--}}

                                    @if($product->before_price>0)
                                        <li><span>EGP {{$product->before_price}}</span></li>
                                        <li>-{{intval(100-( ($product->price / $product->before_price)*100 ))}}% off</li>
                                    @endif
                            ...
                            <div id="selectSize" class="pro-group addeffect-section product-description border-product mb-0">
                                <h6 class="product-title size-text">select size
                                    <span><a href="" data-bs-toggle="modal" data-bs-target="#sizemodal">size chart</a></span>
                                </h6>
                                <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body"><img src="{{asset("website/images/size-chart.jpg")}}" alt="" class="img-fluid "></div>
                                        </div>
                                    </div>
                                </div>
    ...
    {{--                            </div>--}}
                                ...
                                <form id="productCartFormItem" action="{{route('web.CartList.addNew',$product->slug)}}">
                                    <div class="qty-box">
                                        <div class="input-group">
                                            <button class="qty-minus" type="button"></button>
                                                <input class="qty-adj form-control" name="quantity" type="number" value="1" max="{{$product->stock}}" min="1"/>
...
{{--                                        @if($product->added_to_cart)--}}
                                            <button type="button"
                                                    id="cartFormEffect"
                                                    data-cart-form="#productCartFormItem"
                                                    class="btn {{$product->added_to_cart == true?'btn-success':'btn-normal'}} cart-btn tooltip-top"
                                                    style="padding: 13px 18px;font-size: .85rem;"
                                                    data-tippy-content="Add to cart">
                                                    <i class="fa fa-shopping-cart"></i>
                                                    add to cart
                                            </button>
{{--                                        @endif--}}
                                        @if($product->added_to_wishlist)
                                            <button type="button"
                                                    class="btn btn-success tooltip-top"
                                                    style="padding: 13px 18px;font-size: .85rem;">
...
{{--                            </div>--}}
                            ...
                            <div class="pro-group" style="padding: 10px 20px;background-color: #eee">
                                <h6 class="product-title">product information</h6>
                                <div class="single-product-tables row">
                                    ...
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <span>
                                                <a href="{{route("web.products.relation.all",["relation"=>"brand_products","relate_id"=>$product->brand->id])}}">
                                                    <img src="{{$product->brand->logo_url}}"
                                                         class="brand-img" alt="{{$product->brand->name}}" style="width: 40px;margin: 0 5px;border: 1px solid #ccc;padding: 2px;">
                                                    {{$product->brand->name}}
                                                </a>
                                            </span>
                                        </div>
...
{{--                                            </strong>--}}
{{--                                            <span>--}}
{{--                                                <a href="{{route("web.products.relation.all",["relation"=>"seller_products","relate_id"=>$product->seller->id])}}">--}}
{{--                                                    {{$product->seller->name}}--}}
{{--                                                </a>--}}
{{--                                            </span>--}}
{{--                                        </div>--}}
                                    ...
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <span>
                                                <a href="{{route("web.products.relation.all",["relation"=>"manufacture_products","relate_id"=>$product->manufacturer->id])}}">
    ...
    {{--                                    </div>--}}
                    ...
                    <div class="col-lg-3 col-sm-3 collection-filter">
                        <div class="collection-filter-block creative-card creative-inner">
                            <div class="collection-mobile-back"><span class="filter-back"><i class="fa fa-angle-left" aria-hidden="true"></i> back</span></div>
                            <div class="collection-collapse-block border-0 open">
                                <h3 class="collapse-block-title">Branches</h3>
                                <div class="collection-collapse-block-content">
                                    <div class="collection-brand-filter">
                                        <ul class="category-list">
                                            @foreach($product->branch as $branch)
                                                <li>
                                                    <a href="{{route("web.products.relation.all",["relation"=>"branch_products","relate_id"=>$branch->id])}}">{{$branch->name}}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
