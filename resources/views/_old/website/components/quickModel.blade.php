      ...
      <div class="modal-body">
        ...
        <div id="product-quick-view" class="row">
          <div class="col-lg-6 col-xs-12">
            ...
            <div id="quick-view-img" class="quick-view-img"></div>

          </div>
          <div id="product-data" class="col-lg-6 rtl-text">
            <div class="product-right">
              <div class="pro-group quick-view-data">
                <h2>

                </h2>
{{--                <ul class="pro-price">--}}
{{--                  <li class="_price">EGP 70</li>--}}
{{--                  <li class="_sale"><span>EGP 140</span></li>--}}
{{--                  <li class="_offer">50% off</li>--}}
{{--                </ul>--}}
...
{{--                </div>--}}
                  ...
                  <form id="quickCartFormItem" action="{{route('web.CartList.addNew','slug')}}">
                      <h6 class="product-title">quantity</h6>
                      <div class="qty-box">
                          <div class="input-group">
                              <button class="qty-minus" type="button"></button>
                                <input class="qty-adj form-control" name="quantity" type="number" value="1" max="" min="1"/>
                              <button class="qty-plus" type="button"></button>
                          </div>
                      </div>
                      <div class="product-buttons">
                          <button id="quickCartFormEffect" type="button"
                                  class="btn btn-normal cart-btn tooltip-top"
                                  data-cart-form="#quickCartFormItem"
                                  style="padding: 13px 18px;font-size: .85rem;"
                                  data-tippy-content="Add to cart">
                              <i class="fa fa-shopping-cart"></i>
                              add to cart
                          </button>
                          <a id="_view-details" href="#" class="btn btn-normal tooltip-top"  data-tippy-content="view detail">
                              view detail
                          </a>
                      </div>
                  </form>
