                ...
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        {!! Form::open([
                            ...
                            'url' => route('seller.products.importSheet'), 'class' => 'tab-wizard vertical wizard-circle', 'id' => 'add_category_form']) !!}

                            <h6>Excel/CSV File</h6>

                            <section class="mt-4 mb-4">
                                <div class="form-group border border-info rounded text-center p-4 m-auto">
                                    <label for="excelFile" class="text-center mb-4">{{__("seller.ImpExcelF")}}</label>
                                    <input type="file" name="excelFile" class="form-control required col-md-7 d-block m-auto" required>
                                    <div class="b-block">
                                        <a href="{{route("seller.sheetTemp")}}" class="btn btn-info btn-content mt-3 mb-3"> <i class="fa fa-file-download"></i> {{__("seller.dProductsEx")}} </a>
                                    </div>
                                </div>
                            </section>
