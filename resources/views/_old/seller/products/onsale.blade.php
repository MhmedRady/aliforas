    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">{{__("seller.pOnSale")}}</h4>
            </div>
                            ...
                            <table id="table_id" class="table table-bordered table-striped text-center">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>{{__("seller.n")}}</th>
                                        <th>{{__("seller.Brand")}} / {{__("seller.Category")}}</th>
                                        <th>{{__("seller.act")}}</th>
                                        <th>{{__("seller.saleEndAt")}}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$product->name}}</td>
                                        <td>{{isset($product->brand) ? $product->brand->translate(\Lang::getLocale())->name : ""}}
                                            / {{isset($product->categories[0]) ? $product->categories[0]->translate(\Lang::getLocale())->name : ""}}</td>
                                        <td>
