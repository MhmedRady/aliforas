...
<div class="form-group">
    ...
    <input type="number" step="1" class="form-control required" id="minimum_stock" value="{{ old('minimum_stock') }}"
           min="0" name="minimum_stock" required>
</div>

<div class="form-group">
    <label for="price">Price</label>
    <input type="number" class="form-control required" id="price" min="0" value="{{ old('price') }}" name="price"
           required>
</div>

<div class="form-group">
    <label for="reward_points">Reward Points</label>
    <input type="number" class="form-control required" id="price" min="0" value="{{ old('reward_points') === null ? 0 : old('reward_points')}}"
           name="reward_points">
</div>
...
<div class="form-group" data-show="return_allowed" style="display: none">
    ...
    <input type="number" step="1" class="form-control" min="0" value="{{ old('return_duration') }}" id="return_duration"
           name="return_duration" max="30" onchange="max_value()">
</div>
...
<div class="form-group" data-show="on_sale" style="display: none">
    ...
    <input type="number" class="form-control" min="0" id="before_price" name="before_price"
           value="{{ old('before_price') }}">
</div>
