                ...
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        {!! Form::open([
                            ...
                            'url' => route('seller.products.update', $row->id), 'class' => 'tab-wizard vertical wizard-circle', 'id' => 'add_category_form']) !!}
                        {{ method_field('PATCH') }}
                        ...
                        <h6>Stock & Branch</h6>
                        <section>
                            <h6 class="text-info">Stock & Branch Details</h6>

                            <div class="table-responsive">
                                <table class="table  table-bordered">
                                    <thead>
                                    <tr>
                                        <th class="py-1">Branch Name</th>
                                    ...
                                    @foreach($row->branches as $b)
                                        <tr>
                                            ...
                                            <td class="p-0"><input type="number" min="0" value="{{$b->pivot->quantity??0}}" class="form-control" name="branch_qte[]"></td>
                                        </tr>
                                    @endforeach
                                    @foreach($branches as $b)
                                        <tr>
                                            <input type="hidden" name="branch_id[]" value="{{$b->id}}">
                                            <td class="py-2">{{$b->name}}</td>
                                            <td class="p-0"><input type="number" min="0" value="0" class="form-control" name="branch_qte[]"></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                            ...
                            <div class="form-group">
                                ...
                                <input  min="0" type="number" class="form-control required" id="price" name="price" required value="{{ $row->price }}">
                            </div>
                            ...
                            <div class="form-group" data-show="on_sale" style="display: none">
                                ...
                                <input min="0" type="number" class="form-control" id="before_price" name="before_price" value="{{ $row->before_price }}">
                            </div>
                        ...
                        <section>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="length" name="length" value="{{ $row->length }}">
                            </div>
                            <div class="form-group">
