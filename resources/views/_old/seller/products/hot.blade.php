...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">{{__("seller.hotProducts")}}</h4>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!!$product->is_active === 0?'<a href="'.route('seller.products.active', $product->id).'" class="btn waves-effect waves-light btn-outline-success" title="active">Activate</a>':'<a href="'.route('seller.products.active', $product->id).'" class="btn waves-effect waves-light btn-outline-danger" title="inactive">InActivate</a>'!!}
