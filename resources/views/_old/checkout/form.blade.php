                                            ...
                                            <div class="payment-box">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="coupon_code" placeholder="insert coupon code" id="coupon_code" value="{{ old('coupon_code') }}">
                                                        <button class=" btn btn-normal" id="coupon_submitter" style="cursor:pointer;font-size: 12px;padding: 10px 10px;">
...
<script>
$("#coupon_submitter").click(function(){
  var id = $('#coupon_code').val();
  if(id !== ''){
    var url = '/coupon/apply/' + id;
    window.location = url;
  } else {
    $('#coupon_code').focus();
  }
