...
(function ($) {
    ...
    $(window).scroll(function () {
        if ($(document).height() > (window.innerHeight + 600) && $(this).scrollTop() > 250)
    ...
    //     qtyDec.addEventListener("click", function (e) {
    //         let max = e.target.previousElementSibling.max;
    //         if (e.target.previousElementSibling.value < max) {
    //             e.target.previousElementSibling.value = (val) => e.target.previousElementSibling.value*1+1 ;
    //         }
    //
    //     })
    // })
